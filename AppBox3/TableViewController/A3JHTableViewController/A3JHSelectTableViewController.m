//
//  A3JHSelectTableViewController.m
//  AppBox3
//
...
@interface A3JHSelectTableViewController ()

@end

@implementation A3JHSelectTableViewController
...
NSString *jhSelectTableViewCellIdentifier = @"SelectTableViewCell";
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:jhSelectTableViewCellIdentifier forIndexPath:indexPath];

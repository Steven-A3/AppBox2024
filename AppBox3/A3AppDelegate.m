...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    comp.month = 4;
    comp.day = 1;
    NSDate *lunarDate = [NSDate dateOfSolarFromLunarDate:[[NSCalendar currentCalendar] dateFromComponents:comp] leapMonth:YES korean:[A3DateHelper isCurrentLocaleIsKorea] resultLeapMonth:&isResultLeapMonth];

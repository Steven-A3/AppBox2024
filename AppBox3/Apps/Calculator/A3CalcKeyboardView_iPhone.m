...
- (NSArray *)buttonTitlesLevel1 {
	return @[
			...
			@{kA3CalcButtonTitle:[UIImage imageNamed:@"sign_i"], kA3CalcButtonID:@(A3E_SIGN)},
			...
			@{kA3CalcButtonTitle:[UIImage imageNamed:@"squareroot_i"], kA3CalcButtonID:@(A3E_SQUAREROOT)},
			@{kA3CalcButtonTitle:[UIImage imageNamed:@"cuberoot_i"], kA3CalcButtonID:@(A3E_CUBEROOT)},
			@{kA3CalcButtonTitle:[UIImage imageNamed:@"nthroot_i"], kA3CalcButtonID:@(A3E_NTHROOT)},
			...
			@{kA3CalcButtonTitle:[UIImage imageNamed:@"dividex_i"], kA3CalcButtonID:@(A3E_DIVIDE_X)},
			@{kA3CalcButtonTitle:@"x!", kA3CalcButtonID:@(A3E_FACTORIAL)},
			@{kA3CalcButtonTitle:[UIImage imageNamed:@"pi_i"], kA3CalcButtonID:@(A3E_PI)},

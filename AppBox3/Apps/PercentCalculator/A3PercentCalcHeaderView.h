...
//@property (weak, nonatomic) IBOutlet A3OverlapedCircleView *sliderLine1Thumb;
//@property (weak, nonatomic) IBOutlet A3OverlapedCircleView *sliderLine2Thumb;
...
//@property (weak, nonatomic) IBOutlet NSLayoutConstraint *thumb1_leadingConst;
//@property (weak, nonatomic) IBOutlet NSLayoutConstraint *thumb2_leadingConst;
@property (strong, nonatomic) UIView *bottomLineView;

//@property (strong, nonatomic) UILabel *slider1ResultLabel;
//@property (strong, nonatomic) UILabel *slider2ResultLabel;

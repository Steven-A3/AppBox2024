...
- (void)viewDidLoad
{
	...
	[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(rightViewWillDismiss) name:A3NotificationRightSideViewWillDismiss object:nil];
...
- (void)calculatorViewController:(UIViewController *)viewController didDismissWithValue:(NSString *)valueObject {
	...
	_lastEditingTextField.text = [self stringFromNumber:[numberFormatter numberFromString:valueObject] withCurrencyCode:currencyFavorite.currencyCode];
...
- (id)activityViewController:(UIActivityViewController *)activityViewController itemForActivityType:(NSString *)activityType
{
	if ([activityType isEqualToString:UIActivityTypeMail]) {
		...
		[txt appendString:@"<br/><br/>You can convert more in the AppBox Pro.<br/><img style='border:0;' src='http://apns.allaboutapps.net/allaboutapps/appboxIcon60.png' alt='AppBox Pro'><br/><a href='https://itunes.apple.com/us/app/appbox-pro-swiss-army-knife/id318404385?mt=8'>Download from AppStore</a></body></html>"];

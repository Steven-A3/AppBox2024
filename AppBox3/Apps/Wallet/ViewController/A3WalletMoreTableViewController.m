...
{
    if (![[NSUserDefaults standardUserDefaults] boolForKey:A3V3InstructionDidShowForWalletMore]) {
...
{
	[[NSUserDefaults standardUserDefaults] setBool:YES forKey:A3V3InstructionDidShowForWalletMore];

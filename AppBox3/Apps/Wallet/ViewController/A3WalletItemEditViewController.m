...
#ifdef __IPHONE_8_0
                if (IS_IPAD) {
                    A3WalletItemRightIconCell *cell = (A3WalletItemRightIconCell *)[self.tableView cellForRowAtIndexPath:indexPath];
                    CGRect rect = [self.tableView convertRect:cell.iconImgView.frame fromView:cell.contentView];

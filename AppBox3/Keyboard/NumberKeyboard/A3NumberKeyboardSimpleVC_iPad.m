...
- (void)rotateToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation {
	...
	if (IS_PORTRAIT) {
		...
		CGFloat offsetX = bounds.size.height != 1024 ? -108.65 : 0.0;
		width_big = 124.0 * scaleX, height_big = 118.0 * scaleY;
		width_small = 89.0 * scaleX, height_small = 57.0 * scaleY;
		col_1 = 74.0 * scaleX;
		col_2 = 237.0 * scaleX + offsetX;
		col_3 = 338.0 * scaleX + offsetX;
		col_4 = 440.0 * scaleX + offsetX;
		col_5 = 570.0 * scaleX + offsetX;
		...
		CGFloat offsetX = bounds.size.height !=  768 ? -142.65 : 0;
		width_big = 172.0 * scaleX, height_big = 164.0 * scaleY;
		width_small = 108.0 * scaleX, height_small = 77.0 * scaleY;
		
		col_1 = 114.0 * scaleX;
		col_2 = 332.0 * scaleX + offsetX;
		col_3 = 455.0 * scaleX + offsetX;
		col_4 = 578.0 * scaleX + offsetX;
		col_5 = 735.0 * scaleX + offsetX;

...
//  AppBox3
//
//  Created by Byeong Kwon Kwak on 05/18/13.
...
@interface A3BlackBarButton ()
@property (nonatomic, strong) CAGradientLayer *gradientLayer;
@end

@implementation A3BlackBarButton
...
- (void)configureLayers {
	if (nil == _gradientLayer) {
		...
		_gradientLayer.borderColor = [UIColor colorWithRed:20.0/255.0 green:20.0/255.0 blue:20.0/255.0 alpha:1.0].CGColor;
		_gradientLayer.cornerRadius = 5.0;
		[self.layer insertSublayer:_gradientLayer atIndex:0];
	}
	[self setTitleColor:[UIColor colorWithRed:197.0 / 255.0 green:198.0 / 255.0 blue:199.0 / 255.0 alpha:1.0] forState:UIControlStateNormal];
...
- (void)setGradientLayerColor {
	if (self.highlighted) {
		...
		_gradientLayer.colors = @[(id)[UIColor colorWithRed:70.0/255.0 green:71.0/255.0 blue:71.0/255.0 alpha:1.0].CGColor,
				(id)[UIColor colorWithRed:27.0/255.0 green:27.0/255.0 blue:28.0/255.0 alpha:1.0].CGColor];
	}
}

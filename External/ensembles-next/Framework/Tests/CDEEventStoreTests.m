...
- (void)testRegisteringIncompleteMandatoryEvent
{
    ...
    XCTAssertEqual(store.incompleteMandatoryEventIdentifiers.count, (NSUInteger)1, @"Should have one incomplete");
    XCTAssertEqualObjects(store.incompleteMandatoryEventIdentifiers[0], @"TestID", @"Wrong id");
...
- (void)testDeregisteringIncompleteEvent
{
    ...
    XCTAssertEqual(store.incompleteMandatoryEventIdentifiers.count, (NSUInteger)0, @"Should have one incomplete");
}
...
- (void)testPersistenceOfIncompleteEvents
{
    ...
    XCTAssertEqual(newStore.incompleteMandatoryEventIdentifiers.count, (NSUInteger)1, @"Should have one incomplete");
}

...
- (instancetype)init
{
    ...
    _currentBaselineIdentifier = @"store1baseline";
...
@implementation CDEMockPersistentStoreEnsemble
...
@synthesize testModel = testModel;
...
- (void)setUp
{
    ...
    NSString *tempDir = [testRootDirectory stringByAppendingPathComponent:@"tmp"];
    ...
    eventStore.pathToTemporaryDirectory = tempDir;
    ...
    testModel = [[NSManagedObjectModel alloc] initWithContentsOfURL:testModelURL];

...
- (void)setUp
{
    ...
    [self mergeEvents];
    XCTAssertTrue([self.testManagedObjectContext save:&error], @"Save failed");
...
{
    XCTAssertNotNil(parent1, @"Parent should not be nil");
    XCTAssertNotNil(child1, @"Child should not be nil");

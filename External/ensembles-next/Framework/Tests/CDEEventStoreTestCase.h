...
@property (readwrite) NSString *pathToTemporaryDirectory;
...
@interface CDEMockPersistentStoreEnsemble : NSObject

@property (readwrite) NSManagedObjectModel *managedObjectModel;
...
@property (readonly) NSManagedObjectModel *testModel;

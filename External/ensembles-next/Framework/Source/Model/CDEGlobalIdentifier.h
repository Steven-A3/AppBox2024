...
+ (NSArray *)fetchGlobalIdentifiersForIdentifierStrings:(NSArray *)idStrings withEntityName:(NSString *)entityName inManagedObjectContext:(NSManagedObjectContext *)context;

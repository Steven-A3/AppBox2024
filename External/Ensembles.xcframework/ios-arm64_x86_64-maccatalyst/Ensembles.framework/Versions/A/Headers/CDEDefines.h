...
typedef NS_ENUM(NSInteger, CDEErrorCode) {
    ...
    // Hardware identifier changed between launches. Forces a deleech.
    CDEErrorCodeHardwareIdentityChanged     = 213,
    ...
    /// Requested cloudPath is file but expected to be directory.
    CDEErrorCodeExpectedDirectoryGotFile    = 2001
};
